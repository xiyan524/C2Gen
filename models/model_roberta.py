...
class RoBertaMTSep(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, 
                ...
                reduce=True, primitive_labels=None, reason_labels=None, mode="train"):
        ...
        if mode == "train":
            loss_primitive = self.loss_fn(composition_logits, primitive_labels)
            loss_reason = self.loss_fn(reason_logits, reason_labels)
            loss = loss_primitive + self.loss_ratio * loss_reason
